...
public:
	...
	int size() const; /*etapa 2: implemente esta funcao sem usar o membro de dados dataSize*/ // na STL List, a funcao size() calcula o tamanho da lista dinamicamente (exercicio: qual a ordem de complexidade?)
...
public:
	MyList2Iterator(Node<T> *ptr_,const MyList2<T> *ptrLista_) : ptr(ptr_), ptrLista(ptrLista_) {}
